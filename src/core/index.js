...
const GAME_SETTINGS = {
    Private: {
        ...
        seaLevel: 0,
        simTicks: 16,
        vegetationSpreadLand: 5, // [percent]
    ...
    Public: {
        Game: {
            ...
            simulationDistance: [4, 'The radius of chunks that get their data updated from the center of the screen.'],
        },
    },
}
